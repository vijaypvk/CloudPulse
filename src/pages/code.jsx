...
// import { VscFileCode, VscSettingsGear, VscSearch, VscDebugConsole, VscChromeClose, VscDebug, VscServerEnvironment, VscJson, VscGlobe, VscTerminal, VscOutput } from "react-icons/vsc";
// import { FiMaximize, FiChevronRight, FiAlertTriangle, FiCpu } from "react-icons/fi";
// import { GoGlobe } from "react-icons/go";
// import { BiNetworkChart } from "react-icons/bi";
// import { AiOutlineCloudServer } from "react-icons/ai";
// import Header from '../components/header';
// export default function CloudflareWorkersUI() {
//   const [code, setCode] = useState(`// Cloudflare Worker example
...
//       </div>
//       {/* Header */}
//       <div className="bg-[#1e1e1e] px-4 py-2 border-b border-gray-800 flex items-center">
//         <div className="flex items-center">
//           <AiOutlineCloudServer className="text-blue-400 text-2xl mr-2" />
//           <span className="font-semibold text-lg">Serverless Functions</span>
//         </div>
//         <div className="ml-auto flex items-center space-x-3">
//           <div className="bg-gray-800 px-3 py-1 rounded-full text-xs flex items-center">
...
//         <div className="w-12 bg-[#252526] flex flex-col items-center space-y-4 py-4 border-r border-gray-800">
//           <div className="p-2 hover:bg-gray-700 rounded">
//             <VscFileCode className="text-gray-400 text-2xl" title="Files" />
//           </div>
//           <div className="p-2 hover:bg-gray-700 rounded">
//             <VscSearch className="text-gray-400 text-2xl" title="Search" />
//           </div>
//           <div className="p-2 hover:bg-gray-700 rounded">
//             <VscServerEnvironment className="text-gray-400 text-2xl" title="Environment" />
//           </div>
//           <div className="p-2 hover:bg-gray-700 rounded">
//             <BiNetworkChart className="text-gray-400 text-2xl" title="Network" />
//           </div>
//           <div className=" p-2 hover:bg-gray-700 rounded ">
//             <VscSettingsGear className="text-gray-400 text-2xl" title="Settings" />
//           </div>
//         </div>
...
//           {/* File Tab */}
//           <div className="bg-[#1e1e1e] border-b border-gray-800 flex items-center">
//             <div className="px-4 py-2 bg-[#252526] flex items-center border-r border-gray-700">
//               <span className="text-blue-400 text-xs">index.js</span>
...
//           {/* Editor Status Bar */}
//           <div className="bg-[#1e1e1e] text-gray-400 text-xs p-2 border-t border-gray-800 flex justify-between items-center">
...
//             <button 
//               className={`px-4 py-2 text-sm flex items-center ${activeTab === "console" ? "bg-[#1e1e1e] text-white border-t-2 border-blue-500" : "text-gray-400 hover:bg-gray-800"}`}
...
//             </button>
//             <button 
//               className={`px-4 py-2 text-sm flex items-center ${activeTab === "preview" ? "bg-[#1e1e1e] text-white border-t-2 border-blue-500" : "text-gray-400 hover:bg-gray-800"}`}
...
//             </button>
//             <button 
//               className={`px-4 py-2 text-sm flex items-center ${activeTab === "logs" ? "bg-[#1e1e1e] text-white border-t-2 border-blue-500" : "text-gray-400 hover:bg-gray-800"}`}
...
//                 <div className="flex-1 bg-gray-900 rounded flex items-center px-2">
...
//           {activeTab === "console" && (
//             <div className="flex-1 bg-[#1e1e1e] text-white font-mono text-sm p-2 overflow-auto">
...
//                 {output && (
//                   <>
//                     <div className="text-green-400">&gt; Function executed successfully</div>
//                     <pre className="whitespace-pre-wrap text-gray-300 pl-4 border-l-2 border-green-500 bg-opacity-10 bg-green-900 p-2 rounded">
//                       {output}
//                     </pre>
//                   </>
//                 )}
//                 {error && (
//                   <>
//                     <div className="text-red-400">&gt; Function execution failed</div>
//                     <pre className="whitespace-pre-wrap text-gray-300 pl-4 border-l-2 border-red-500 bg-opacity-10 bg-red-900 p-2 rounded">
//                       {error}
//                     </pre>
//                   </>
//                 )}
//                 {deployStatus === "success" && (
//                   <div className="text-green-400 bg-green-900 bg-opacity-10 p-2 rounded">
...
//                 <span className="text-gray-400">Function logs</span>
//                 <button className="text-xs text-blue-400 hover:underline">Clear logs</button>
//               </div>
//               <div className="text-gray-500">No logs available. Execute your function to generate logs.</div>
//             </div>
//           )}
//         </div>
//       </div>
...
import Editor from "@monaco-editor/react";
import { VscFileCode, VscSettingsGear, VscSearch, VscDebugConsole, VscChromeClose, VscDebug, VscServerEnvironment, VscJson, VscGlobe, VscTerminal, VscOutput } from "react-icons/vsc";
import { FiMaximize, FiChevronRight, FiAlertTriangle, FiCpu, FiSun, FiMoon } from "react-icons/fi";
import { GoGlobe } from "react-icons/go";
import { BiNetworkChart } from "react-icons/bi";
import { AiOutlineCloudServer } from "react-icons/ai";
import Header from '../components/header';
  ...
  return (
    <div className={`h-screen flex flex-col ${themeClasses.app}`}>
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 flex flex-col">
          {/* File Tab */}
          <div className={`border-b flex items-center ${themeClasses.header}`}>
